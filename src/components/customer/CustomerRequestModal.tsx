...
export default function CustomerRequestModal({ open, onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/55 p-5" role="dialog" aria-modal="true" aria-label="New maintenance request">
      <form onSubmit={submit} className="max-h-[91vh] w-full max-w-[725px] overflow-y-auto rounded-[18px] bg-white shadow-2xl">
        ...
        <div className="space-y-5 px-8 py-7">
          ...
          <fieldset><legend className="mb-3 text-[12px] font-bold tracking-[.12em] text-[#708887]">SERVICE CATEGORY</legend><div className="grid grid-cols-3 gap-2.5">
