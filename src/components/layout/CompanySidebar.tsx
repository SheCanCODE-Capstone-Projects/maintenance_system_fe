...
export default function CompanySidebar({
  ...
  return (
    <aside
      ...
      className="flex w-[72px] shrink-0 flex-col border-r border-[#113b37] bg-[#0D3330] text-[#a6c0bd] lg:w-[292px]"
    >
        ...
        {navItems.map(({ icon: Icon, label, href }) => {
          ...
          return (
            <Link
              ...
              className={`group flex items-center justify-center gap-3 rounded-xl px-2 py-3 text-[15px] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF6224] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0D3330] lg:justify-start lg:px-4 ${
                active
