...
const links = [
  { label: "Overview", href: "/dashboard/technician", icon: Wrench },
  { label: "Jobs", href: "/dashboard/technician/jobs", icon: Wrench },
  { label: "Earnings", href: "/dashboard/technician/earnings", icon: Wrench },
  { label: "Subscription", href: "/dashboard/technician/subscription", icon: Wrench },
  { label: "Profile", href: "/dashboard/technician/profile", icon: Wrench },
] as const;
